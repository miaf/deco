class User < ActiveRecord::Base
	...
	validates_presence_of :id_ref_numb, message: ""
	validates_length_of :id_ref_numb, in: 3..30, message: "between 3 and 30 characters"
	...
	validates_presence_of :login_name, message: ""
